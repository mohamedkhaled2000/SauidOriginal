        ...
        <div class="container">
          ...
          <div class="row justify-content-center" data-aos="fade-up">
            ...
            <div class="col-lg-10">
              ...
              <div class="info-wrap" style="text-align: right">
                <div class="row">
          ...
          <div class="row mt-5 justify-content-center" data-aos="fade-up">
            <div class="col-lg-10">
              ...
              <form action="{{ route('store.form') }}" method="post" role="form" class="php-email-form">
                @csrf
                <div class="form-row">
                  ...
                  <div class="col-md-6 form-group">
                    <input type="email" class="form-control" name="email" id="email" placeholder="ايميلك" data-rule="email" data-msg="Please enter a valid email" />
                  </div>
                </div>
